    ...
    <>
      <div className="bg-white border rounded-xl p-1.5 shadow-sm">
            ...
            <TableBody>
              {cards.map((card: any) => (
                <TableRow key={card.id} className="hover:bg-gray-50 transition">
                  ...
                  {/* Pack */}
                  <TableCell className="py-4 max-w-[180px] min-w-0 overflow-hidden text-ellipsis whitespace-nowrap text-sm lg:text-base text-gray-600">
        ...
        <div className="md:hidden space-y-4 p-2">
          {cards.map((card: any) => (
            <div key={card.card_id} className="border rounded-xl p-4 shadow-sm space-y-3">
